        ...
        {items.map((item) => (
          <li key={item.id}>
            <button
              ...
              className="w-full text-left px-4 sm:px-6 py-2 sm:py-5 hover:bg-gray-50 active:bg-gray-100 transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-gray-900 focus-visible:outline-offset-2"
            ...
            >
              <div className="flex items-start gap-3 sm:gap-6">
                ...
                <div className="min-w-0 flex-1">
                  <h2
                    className="text-[13px] sm:text-3xl font-medium text-black leading-tight break-words truncate sm:whitespace-normal"
                    style={{ fontFamily: 'Georgia, serif' }}
                  >
                    {item.title}
                  </h2>
                  <div className="mt-1 flex items-center gap-2 text-[9px] sm:text-sm font-semibold tracking-wide text-black uppercase">
