        ...
        {items.map((item) => (
          <li key={item.id} className="m-0">
            <button
              ...
              className="w-full min-h-0 h-auto text-left px-4 sm:px-6 py-0 sm:py-5 hover:bg-gray-50 active:bg-gray-100 transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-gray-900 focus-visible:outline-offset-2"
