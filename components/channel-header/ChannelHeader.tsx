      ...
      <div className="px-4 sm:px-6 pt-6 sm:pt-8 pb-5 sm:pb-6">
        <div className="flex items-start gap-4 sm:gap-6">
          ...
          <div className="min-w-0">
            <h1
              className="text-2xl sm:text-4xl font-semibold text-black leading-tight break-words"
              style={{ fontFamily: 'Georgia, serif' }}
            >
              {name}
            </h1>
            <p
              className="mt-2 text-sm sm:text-base text-gray-700 leading-relaxed break-words"
              style={{ fontFamily: 'Georgia, serif' }}
            >
              {description}
            </p>
